...
#########################################################################################################################
#																														#
#       Title:                 	AWS_reporting_Subnets.sh    	                                                    	#
#       Purpose:                Gather AWS Subnets and write output to file		 	                            		#
...
REPORT_NAME=AWS_reporting_Subnets									# Name of the Report
...
do
    ...
    aws ec2 describe-subnets --region $REGION --profile $PROFILE --output=$OUTPUT_FORMAT > ${REPORT_NAME}.${PROFILE}.${REGION}.${OUTPUT_FORMAT}
done
