...
#########################################################################################################################
#																														#
#       Title:                 	AWS_reporting_EC2.sh                                                                 	#
#       Purpose:                Gather AWS EC2 resources and write output to file 	                                 	#
...
REPORT_NAME=AWS_reporting_EC2 										# Name of the Report
...
do
    ...
    aws ec2 describe-instances --region $REGION --profile $PROFILE --output=$OUTPUT_FORMAT > ${REPORT_NAME}.${PROFILE}.${REGION}.${OUTPUT_FORMAT}
done
