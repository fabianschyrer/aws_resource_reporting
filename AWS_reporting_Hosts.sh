...
#########################################################################################################################
#																														#
#       Title:                 	AWS_reporting_Hosts.sh                                                               	#
#       Purpose:                Gather AWS Hosts and write output to file		 	                                 	#
...
REPORT_NAME=AWS_reporting_Hosts 									# Name of the Report
...
do
    ...
    aws ec2 describe-hosts --region $REGION --profile $PROFILE --output=$OUTPUT_FORMAT > ${REPORT_NAME}.${PROFILE}.${REGION}.${OUTPUT_FORMAT}
done
