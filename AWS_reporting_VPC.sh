...
#########################################################################################################################
#																														#
#       Title:                 	AWS_reporting_VPCs.sh    		                                                    	#
#       Purpose:                Gather AWS VPCs and write output to file		 	                            		#
...
REPORT_NAME=AWS_reporting_VPCs										# Name of the Report
...
do
    ...
    aws ec2 describe-vpcs --region $REGION --profile $PROFILE --output=$OUTPUT_FORMAT > ${REPORT_NAME}.${PROFILE}.${REGION}.${OUTPUT_FORMAT}
done
